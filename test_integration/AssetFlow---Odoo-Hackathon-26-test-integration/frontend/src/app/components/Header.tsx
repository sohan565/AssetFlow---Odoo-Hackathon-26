    ...
    <header className="sticky top-0 z-40 mb-6">
      <div className="rounded-[var(--radius)] border border-border bg-card/60 backdrop-blur-xl px-4 sm:px-5 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-2.5 pl-1">
          ...
          <span className="grid place-items-center size-10 rounded-full ring-2 ring-emerald-400/40 bg-white/10 font-[var(--font-display)] text-sm shrink-0">
            {initials}
          </span>
          <button
            onClick={logout}
            title="Log Out"
            className="grid place-items-center size-10 rounded-xl border border-border bg-white/[0.03] text-muted-foreground hover:text-rose-300 hover:border-rose-500/30 transition-colors ml-1"
          >
